...
public class StuffiumArmorItem extends OofyeetkutmodModElements.ModElement {
	@ObjectHolder("oofyeetkutmod:stuffium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("oofyeetkutmod:stuffium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("oofyeetkutmod:stuffium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("oofyeetkutmod:stuffium_armor_boots")
	public static final Item boots = null;
	public StuffiumArmorItem(OofyeetkutmodModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "oofyeetkutmod:textures/models/armor/stuffium__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
