...
public class StuffiumOreBlock extends ImstuffModElements.ModElement {
	@ObjectHolder("imstuff:stuffium_ore")
	public static final Block block = null;
	public StuffiumOreBlock(ImstuffModElements instance) {
		super(instance, 8);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.3f, 16f).setLightLevel(s -> 5).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE).setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("stuffium_ore");
		}
